...
def process_datasets(args, save_path):
    """
    ...
    The arrow dataset will be saved to args.processed_data_dir, and will be needed
    ...
    for filename in tqdm(train_files, desc="Normalizing Data"):
        ...
        connectivity = np.corrcoef(dat_arr)
        ...
        train_dataset_dict["Brain_Network"].append(connectivity)
